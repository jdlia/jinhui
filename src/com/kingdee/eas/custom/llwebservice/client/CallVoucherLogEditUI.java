 ...
 * output class name
 */
public class CallVoucherLogEditUI extends AbstractCallVoucherLogEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(CallVoucherLogEditUI.class);
    
    /**
     * output class constructor
     */
    public CallVoucherLogEditUI() throws Exception
    {
        super();
    }
    /**
