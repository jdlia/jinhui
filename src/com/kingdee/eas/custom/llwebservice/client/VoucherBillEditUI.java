 ...
 * output class name
 */
public class VoucherBillEditUI extends AbstractVoucherBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(VoucherBillEditUI.class);
    
    /**
     * output class constructor
     */
    public VoucherBillEditUI() throws Exception
    {
        super();
    }
    /**
    ...
    {
    	VoucherBillInfo billInfo = (VoucherBillInfo) this.editData;
    	if ((InterfaceBillEnum.AUDIT).equals(billInfo.getStatus())) {
    		MsgBox.showInfo("已审核状态的单据不允许修改");
    		abort();
		}
    ...
    protected void doBeforeSubmit(ActionEvent e) throws Exception {
    	...
    	if (this.editData != null && this.editData.getId() != null) {
	    	if ((InterfaceBillEnum.AUDIT).equals(billInfo.getStatus())) {
	    		MsgBox.showInfo("已审核状态的单据不允许提交");
	    		abort();
			} 
	    	if (billInfo.getDescription() == null || billInfo.getDescription().isEmpty()) {
	    		MsgBox.showInfo("参考信息为空，不允许提交");
	    		abort();
			}
    	}
