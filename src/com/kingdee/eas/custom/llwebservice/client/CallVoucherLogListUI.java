 ...
 * output class name
 */
public class CallVoucherLogListUI extends AbstractCallVoucherLogListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CallVoucherLogListUI.class);
     ...
     */
    public CallVoucherLogListUI() throws Exception
    {
        super();
    }
    ...
    {
        super.tblMain_tableDataRequest(e);
    }
