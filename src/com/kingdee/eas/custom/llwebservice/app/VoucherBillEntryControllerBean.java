...
public class VoucherBillEntryControllerBean extends AbstractVoucherBillEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.custom.llwebservice.app.VoucherBillEntryControllerBean");
}