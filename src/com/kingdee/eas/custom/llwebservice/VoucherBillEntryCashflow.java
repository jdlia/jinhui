...
public class VoucherBillEntryCashflow extends CoreBillEntryBase implements IVoucherBillEntryCashflow
{
    public VoucherBillEntryCashflow()
    {
        super();
        registerInterface(IVoucherBillEntryCashflow.class, this);
    }
    public VoucherBillEntryCashflow(Context ctx)
    {
        super(ctx);
        registerInterface(IVoucherBillEntryCashflow.class, this);
    }
    ...
    private VoucherBillEntryCashflowController getController() throws BOSException
    {
        return (VoucherBillEntryCashflowController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getVoucherBillEntryCashflowInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getVoucherBillEntryCashflowInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getVoucherBillEntryCashflowInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getVoucherBillEntryCashflowCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getVoucherBillEntryCashflowCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getVoucherBillEntryCashflowCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
